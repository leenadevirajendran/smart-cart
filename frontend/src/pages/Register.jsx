  ...
  return (
    <div className="min-h-[calc(100vh-73px)] grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex bg-ink flex-col justify-center px-16 relative overflow-hidden">
        <p className="font-mono text-coral text-sm mb-4 tracking-wide">JOIN SMARTCART</p>
        <h1 className="font-display text-4xl font-bold text-white max-w-sm leading-tight mb-4">
          Tech that keeps up with you.
        </h1>
        <p className="text-gray-400 max-w-xs">
          Create an account to track orders, save favorites, and catch flash sales live.
        </p>
      </div>
      ...
      <div className="flex items-center justify-center bg-paper px-4 py-16">
        <div className="w-full max-w-sm">
          <h2 className="font-display text-2xl font-semibold text-gray-800 mb-1">Create your account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cobalt focus:border-transparent bg-white"
              >
